...
<?php include 'Asset/PHP/IncomeData.php' ?>
</head>
<body>
	...
	<div class="content">
		<div class="head-content">
			<div class="title-content">
				<i class="fas fa-grip-lines"></i> <span>Income</span>
			</div>
			<div class="title-bar">
        ...
        <div class="content-1">
			<div class="balance-info">
                ...
                <div class="cardbalance-info">

                    <?php                      
                    while($row = mysqli_fetch_array($resultMinMax)) { ?>
                        <div class="card-1">
                            <p><?php echo $row['min']/1000000?>M<br><span>Lowest</span></p>
                        </div>
                        <div class="card-2">
                            <p><?php echo $row['max']/1000000?>M<br><span>Highest</span></p>
                        </div>
                        <div class="card-3">
                            <p><?php echo $row['payment']?><br><span>Payment</span></p>
                        </div>
                    <?php } ?>
                </div>
            </div>
